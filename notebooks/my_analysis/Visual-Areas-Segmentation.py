...
dataFolder = os.path.join(os.path.expanduser('~'), 'DATA', 
                        'In_Vivo_experiments', 'NDNF-Cre-batch1', 'Processed',
                        'intrinsic_img','07_05_2025', '16-14-44')
...
# NOT WORKING
print("trial ", trial)
print("trial.finalPatches ", trial.finalPatches)
print("trial.finalPatches['patch01'] ", trial.finalPatches['patch01'])
print("center V1 ", trial.finalPatches['patch01'].getCenter())
